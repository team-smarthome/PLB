...
const handleSimpanPerlintasan = async (data, socket, action) => {
    ...
    onProgress = true;
    const { version, userNip, userFullName, jenis, totalData, nationality, is_depart, ipServer } = data;
    ...
    try {
        ...
        for (const record of records) {
            ...
            const paramsSimpanPerlintasan = {
                ...
                "tanggal_akhir_berlaku_dokumen_perjalanan": record?.expired_date ? record?.expired_date : "",
                "id_tpi_luar_negeri": "",
                "id_jenis_visa": "",
                "nomor_visa": "",
                "tanggal_terbit_visa": "",
                ...
                "harga_dalam_usd": "",
                "nama_belakang": "",
                "nama_depan": record?.name ? record?.name : "",
                "tanggal_lahir": record?.date_of_birth ? record?.date_of_birth : "",
                "kode_jenis_kelamin": record?.gender ? record?.gender : "",
                ...
                "Mrz1": "",
                "Mrz2": "",
                "pindai_foto": record?.profile_image ? record?.profile_image : "",
                ...
                "nomor_ijin_tinggal": "",
                "status_cekal": hasilCekal ? hasilCekal : "TIDAK TERHUBUNG",
                ...
                "ip_address_client": ipServer ? ipServer : "10.8.10.3",
                "port_id": record?.tpi_id ? record?.tpi_id.toUpperCase() : "SKOW",
                "user_nip": userNip ? userNip.toUpperCase() : "",
                "user_full_name": userFullName ? userFullName.toUpperCase() : "",
