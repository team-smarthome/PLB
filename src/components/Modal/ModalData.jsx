  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
      <div className="bg-white rounded-lg w-[60%] h-[65%] flex flex-col">
        ...
        {/* Modal Content */}
        <div
          className={`  grid ${inputName || isWaiting ? "grid-cols-1" : "grid-cols-2"}  px-2 flex-grow overflow-y-auto mt-6`}
        >
          {isWaiting && (
          ...
          {inputName && (
            <form
              className="flex items-center mt-[-3rem] justify-center"
              onSubmit={handleCheckData}
            >
              <div className="flex items-center justify-center flex-col px-16 pt-10 pb-4 bg-slate-50 rounded-lg">
                <p className="text-slate-800 text-3xl font-semibold">
                  Input Data Log Pelintas Manual
                </p>
                <div className="w-full flex flex-col gap-5">
                  <div>
                    <p className="text-black text-start">
                      Masukan Nomor PLB / BCP
                    </p>
                    <input
                      type="text"
                      ...
                      onChange={(e) =>
                        setSearch({ ...search, no_passport: e.target.value })
                      }
                    />
                  </div>
                  <div>
                ...
                <button className="text-white text-lg font-normal px-10 py-3 bg-navy-900 border-none rounded-lg hover:bg-blue-800 focus:outline-none hover:cursor-pointer mt-4">
                  Cari
                </button>
              </div>
            </form>
        ...
        <div className={`flex justify-end space-x-4 p-4`}>
          {data && (
            <>
              ...
              <button
                className={`text-base text-white px-4 py-3 bg-navy-900 border-none rounded-lg hover:bg-blue-800 focus:outline-none hover:cursor-pointer`}
